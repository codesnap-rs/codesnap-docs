...
export const StarBadge = ({
  ...
  className,
  url,
}: WithStyle<PropsWithChildren<StarBadgeProps>>) => (
  <a href={url}>
    <button
      className={`cursor-pointer w-fit group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden ${className}`}
    >
