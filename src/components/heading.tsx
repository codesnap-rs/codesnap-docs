export const Heading = () => (
  <>
    <h1 className="flex mb-1.5 text-left text-2xl font-semibold tracking-tight sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl [&>span]:dark:from-muted-foreground [&>span]:dark:to-foreground [&>span]:dark:bg-gradient-to-t [&>span]:dark:to-40% [&>span]:dark:bg-clip-text [&>span]:dark:text-transparent">
      The
    ...
    <h1 className="flex text-left text-2xl font-semibold tracking-tight sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl [&>span]:dark:from-muted-foreground [&>span]:dark:to-foreground [&>span]:dark:bg-gradient-to-t [&>span]:dark:to-40% [&>span]:dark:bg-clip-text [&>span]:dark:text-transparent">
